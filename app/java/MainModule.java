...
public class MainModule extends XposedModule {
    ...
    static {
        ...
        // SPOOF_PROPS.put("ro.product.system.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // SPOOF_PROPS.put("ro.product.system_ext.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // SPOOF_PROPS.put("ro.product.system.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // SPOOF_PROPS.put("ro.product.system_ext.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        ...
        // // SPOOF_PROPS.put("ro.product.odm.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // SPOOF_PROPS.put("ro.product.odm.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // [ro.product.vendor]
        ...
        // // SPOOF_PROPS.put("ro.product.vendor.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // SPOOF_PROPS.put("ro.product.vendor.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // [ro.product.product]
        ...
        // // SPOOF_PROPS.put("ro.product.product.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // SPOOF_PROPS.put("ro.product.product.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // // [ro.product.build]
        ...
        // SPOOF_PROPS.put("ro.product.brand", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // SPOOF_PROPS.put("ro.product.manufacturer", "samsung"); // NÃO NECESSÁRIO PORQUE JÁ É SAMSUNG (MANTER COMENTADO)
        // ----------------------------------
    ...
    /**
     * 💡 Função modular genérica que encapsula a lógica de drible da variável
     * 'final'. Elimina a repetição massiva de blocos try/catch.
     */
